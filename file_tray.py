...
def create_project_folder_structure():
    ...
    if not os.path.exists(project_folder_location):
        ...
        log.write_to_log("The project folder '%s' was created." % project_folder_name)
        ...
        log.write_to_log("The folders for service %s were created in project folder '%s'." % (service_selection, project_folder_name))
        ...
        log.write_to_log("The folder '%s' was found at the location. The project folder was not created." % project_folder_name)
